...
\NormalTok{prompt }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}
    ...
    \StringTok{"Response 2:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
    \StringTok{"{-} Political Parties: Liberal Party}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Response 3:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
    \StringTok{"{-} Ministries: Ministry of Health}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Response 4:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
    \StringTok{"{-} Organizations: Greenpeace}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Response 5:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
    \StringTok{"{-} Politicians: Andrew Scheer}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Now, extract the named entities for the following response:}\SpecialCharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Response: }\SpecialCharTok{\textbackslash{}"}\StringTok{"}\NormalTok{, data}\SpecialCharTok{$}\NormalTok{open\_ended\_issue[i], }\StringTok{"}\SpecialCharTok{\textbackslash{}"\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
  
    \StringTok{"Response 1:"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
