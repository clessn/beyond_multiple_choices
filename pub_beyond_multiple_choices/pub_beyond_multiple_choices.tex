...
Open-ended survey questions are notoriously difficult to incorporate in
surveys. They come with a host of challenges. Respondent often skip them
because they are time-consuming and require more effort and reflexion
than closed-ended questions. It can also be troublesome for mobile users
to type lengthy and complex responses \citep{dillman_etal14}. Open-ended
...
quantify. This paper offers a method to easily analyse and quantify
open-ended questions with the use of the R programming language and
Ollama's API, allowing the use of a wide array of open-source language
models directly in the cleaning process, free of charge. This method can
provide valuable insights into the data and help researchers to better
understand the attitudes and opinions of respondents.
...
expertise or reliance on cloud-based platforms. The Ollama API is a
powerful tool that can be used to generate text, summarize documents,
and perform a wide range of other natural language processing tasks for
free. The API is designed to be easy to use and flexible, allowing users
to customize their interactions with LLMs to suit their needs. Using
this tool, we can easily clean and analyze open-ended survey questions
with limited resources.

A R package that allows researchers to interact with various language
models through Ollama's API was built for this paper.
