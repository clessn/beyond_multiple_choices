...
The definition of a "good" F1 score can be context-specific, heavily influenced by the specific nuances of the dataset and the research goals. This is particularly relevant in our analysis, where we compare several models and techniques to categorize open-ended survey responses. By evaluating the F1-scores across different issue categories, we can better understand each model's strengths and weaknesses, providing a clearer picture of what constitutes a good F1 score in our specific application.
...
The code and data used for this project are available at <https://github.com/clessn/beyond_multiple_choices>.
